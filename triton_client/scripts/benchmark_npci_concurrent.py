# python benchmark_npci_concurrent.py --gt-file /home/npci/NPCI/asr_pipeline/npci-triton-benchmarking/en-benchmark-v0109-fixed.csv --audio-folder /home/npci/NPCI/transactional-voice-ai_serving/triton_client/data/npci_pipeline_benchmark/audio --lang en --savefile /home/npci/NPCI/transactional-voice-ai_serving/triton_client/data/npci_pipeline_benchmark/results/temp.csv --batchsize 1
...
if __name__ == "__main__":
    ...
    with ThreadPoolExecutor(max_workers=8) as executor:
        result_responses = list(tqdm(executor.map(send_request, batches), total=len(batches)))
